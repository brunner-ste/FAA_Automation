...
RAW=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/final_heli_'$AREA''
ARCHIVE=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/heli_chart_us.tar.gz'
CONVERTED=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/heli_chart_us'
PACK=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/heli_chart_us/heli_chart_us.pck*'
