...
RAW=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/convert_ilow_'$AREA''
ARCHIVE=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/ilow_'$AREA'.tar.gz'
CONVERTED=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/ilow_'$AREA''
PACK=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/ilow_'$AREA'/ilow_'$AREA'.pck*'
