...
RAW=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/final_sec_'$AREA''
ARCHIVE=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/sec_'$AREA'.tar.gz'
CONVERTED=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/sec_'$AREA''
PACK=''$HOME'/server/Eanserver18/raster/tmp/BR/automated_cycles/faa/tif/sec_'$AREA'/sec_'$AREA'.pck*'
